...
namespace engine
{
    class ovr023
    {
        ...
        internal static byte spell_menu(ref int index, SpellSource spellSource)
        {
            ...
            {
                int selected_index = gbl.spell_string_list.GetRange(0, gbl.spell_string_list.IndexOf(selected))
                    .FindAll(mi => mi.Heading == false).Count;
        ...
        internal static void add_spell_to_list(byte spell_id) /* sub_5C3ED */
        {
            ...
            string_list.Add(
                new MenuItem(string.Format(" {0}{1}", (spell_id > 0x7F) ? '*' : ' ', SpellNames[masked_id])));
        ...
        internal static void add_spell_to_learning_list(int spell_id) /* sub_5C5B9 */
        {
            ...
            string menu_text = string.Format(" {0}{1}{2}",
                ...
                gbl.memorize_count[memorize_index] > 1
                    ? string.Format(" ({0})", gbl.memorize_count[memorize_index])
                    : "");
        ...
        internal static void scroll_5C912(bool learning) /* sub_5C912 */
        {
            if (gbl.SelectedPlayer.HasAffect(Affects.read_magic) == true ||
                ((gbl.SelectedPlayer.cleric_lvl > 0 ||
                  gbl.SelectedPlayer.cleric_old_lvl > gbl.SelectedPlayer.multiclassLevel) &&
        ...
        internal static int SpellRange(int spellId) // sub_5CDE5
        {
            ...
            int range = gbl.spellCastingTable[spellId].fixedRange +
                        (gbl.spellCastingTable[spellId].perLvlRange * castingLvl);
        ...
        internal static ushort GetSpellAffectTimeout(Spells spellId) // sub_5CE92
        {
            ...
            {
                var_4 = gbl.spellCastingTable[(int) spellId].fixedDuration +
                        (gbl.spellCastingTable[(int) spellId].perLvlDuration *
                         ovr025.spellMaxTargetCount((int) spellId));
            }
        ...
        internal static void DoSpellCastingWork(string text, DamageType damageFlags, int damage, bool call_affect_table,
            int TargetCount, int spell_id) // sub_5CF7F
        {
                ...
                foreach (var target in gbl.spellTargets)
                {
                    ...
                    if (gbl.spellCastingTable[spell_id].affect_id > 0)
                    {
                        ovr024.ApplyAttackSpellAffect(text, saved, gbl.spellCastingTable[spell_id].damageOnSave,
                            call_affect_table, target_count, GetSpellAffectTimeout((Spells) spell_id),
                            gbl.spellCastingTable[spell_id].affect_id,
                            target);
                    }
                }
        ...
        internal static void
            sub_5D2E1(ref bool arg_0, bool showCastingText, QuickFight quick_fight, int spell_id) // sub_5D2E1
        {
        ...
        static Point[] unk_16D22 =
        {
            new Point(-1, 0), new Point(0, -1), new Point(0, -1), new Point(1, 0), new Point(1, 0), new Point(0, 1),
            new Point(0, 1), new Point(-1, 0)
        };

        static Point[] unk_16D32 =
        {
            new Point(1, 0), new Point(1, 0), new Point(0, 1), new Point(0, 1), new Point(-1, 0), new Point(-1, 0),
        ...
        internal static void MultiTargetedSpell(string text, int save_bonus) // sub_5DB24
        {
            ...
            foreach (var target in gbl.spellTargets)
            {
                if (firstTimeRound == false)
                {
                    ...
                    ovr025.draw_missile_attack(0x1E, 4, ovr033.PlayerMapPos(target),
                        ovr033.PlayerMapPos(gbl.SelectedPlayer));
                }
                ...
                ovr024.ApplyAttackSpellAffect(text, saved, can_save_flag, false,
                    ovr025.spellMaxTargetCount(gbl.spell_id), GetSpellAffectTimeout((Spells) gbl.spell_id),
        ...
        static void CastTeamSpell(string text, CombatTeam team) // sub_5DCA0
        {
            ...
            gbl.spellTargets.RemoveAll(target => target.combat_team != team ||
                                                 (gbl.spell_id == (int) Spells.bless &&
                                                  gbl.game_state == GameState.Combat &&
                                                  ovr025.BuildNearTargets(1, target).Count > 0));
        ...
        {
            DoSpellCastingWork("", DamageType.Magic | DamageType.Fire, ovr025.spellMaxTargetCount(gbl.spell_id), false,
                0, gbl.spell_id);
        }
        ...
        internal static void SpellCharm() // is_charmed
        {
            ...
            {
                DoSpellCastingWork("is charmed", 0, 0, true,
                    (byte) (((int) gbl.SelectedPlayer.combat_team << 7) + ovr025.spellMaxTargetCount(gbl.spell_id)),
                    gbl.spell_id);
        ...
        internal static void SpellEnlarge() // is_stronger
        {
            ...
            if (ovr024.TryEncodeStrength(out encoded_strength, new_str100, new_str, target) == true)
            {
                ...
                ovr024.add_affect(true, encoded_strength, GetSpellAffectTimeout((Spells) gbl.spell_id), Affects.enlarge,
                    target);
        ...
        internal static void SpellMagicMissile() // sub_5E221
        {
            ...
            DoSpellCastingWork("", DamageType.Magic, (var_1 / 2) + ovr024.roll_dice_save(4, var_1 / 2), false, 0,
                gbl.spell_id);
        }
        ...
        {
            DoSpellCastingWork("", DamageType.Acid | DamageType.Cold,
                ovr024.roll_dice_save(8, 1) + ovr025.spellMaxTargetCount(gbl.spell_id),
        ...
        internal static void SpellStinkingCloud() //TODO similar to spell_poisonous_cloud
        {
            ...
            ovr024.add_affect(true, (byte) (var_10 + (count << 4)), var_10, Affects.affect_in_stinking_cloud,
                gbl.SelectedPlayer);
            ...
            for (int var_11 = 0; var_11 < StinkingCloudMaxTargets; var_11++)
            {
                        ...
                        if (var_4 != var_8)
                        {
                            for (int var_D = 0; var_D < 4; var_D++)
                            {
                                if (var_4.present[var_D] == true &&
                                    gbl.targetPos + gbl.MapDirectionDelta[var_12] == var_4.targetPos +
                                    gbl.MapDirectionDelta[gbl.SmallCloudDirections[var_D]] &&
                ...
                {
                    var c = gbl.downedPlayers.FindLast(
                        cell => cell.map == gbl.targetPos + gbl.MapDirectionDelta[var_12]);
                    if (c != null)
                    {
        ...
        internal static void SpellStrength() // sub_5EC5B
        {
            ...
            if (ovr024.TryEncodeStrength(out encoded_str, str_100, str, target) == true)
            {
                ...
                ovr024.add_affect(true, encoded_str, GetSpellAffectTimeout((Spells) gbl.spell_id), Affects.strength,
                    target);
                ovr024.CalcStatBonuses(Stat.STR, target);
            }
        }
        ...
        internal static void SpellAnimateDead() // is_animated
        {
            ...
            foreach (Player player in gbl.TeamList)
            {
                    ...
                    player.monsterType == 0)
                {
                    ...
                    {
                        byte var_2 =
                            (byte) (((int) player.combat_team << 4) + ovr025.spellMaxTargetCount(gbl.spell_id));
                        ...
                        {
                            ovr024.ApplyAttackSpellAffect("is animated", false, 0, true, var_2, 0, Affects.animate_dead,
                                player);
                                ...
                                if (sub_5F126(var_18.player, maxTargetCount) == true)
                                {
                                    ...
                                    foreach (Affect tmpAffect in var_18.player.affects)
                                    {
                                        if (((affect.type == Affects.affect_in_cloud_kill && ground_tile == 0x1c) ||
                                             (affect.type == Affects.affect_in_stinking_cloud &&
                                              ground_tile == 0x1E)) &&
                                    ...
                                    if (found == true)
                                    {
                                        ...
                                        {
                                            ovr024.remove_affect(affect, Affects.affect_in_stinking_cloud,
                                                var_18.player);
                                        }
                                    }
                                }
        ...
        {
            byte tmpByte =
                (byte) (((int) gbl.SelectedPlayer.combat_team * 16) + ovr025.spellMaxTargetCount(gbl.spell_id));
        ...
        internal static void sub_5F782()
        {
            ...
            DoSpellCastingWork("", DamageType.Magic | DamageType.Fire, ovr024.roll_dice_save(6, dice_count), false, 0,
                gbl.spell_id);
        }
        ...
        static bool DoElecDamage(bool arg_0, int player_index, SaveVerseType bonusType, int damage,
            Point pos) // sub_5F986
        {
            int groundTile;
            int playerIndex;
        ...
        internal static void cast_strength()
        {
            ...
            ovr024.add_affect(true, encodedStrength, (ushort) ((ovr024.roll_dice(4, 1) * 10) + 0x28),
                Affects.strength_spell, target);
            ovr024.CalcStatBonuses(Stat.STR, target);
        }
        ...
        internal static void SpellSticksToSnakes() // cast_flattern
        {
            ...
            {
                DoSpellCastingWork("", DamageType.Magic, 0, false, ovr025.spellMaxTargetCount(gbl.spell_id),
                    gbl.spell_id);
        ...
        {
            ovr024.ApplyAttackSpellAffect(string.Empty, false, 0, false, 0, GetSpellAffectTimeout(Spells.dispel_evil),
                Affects.dispel_evil, gbl.SelectedPlayer);
            DoSpellCastingWork("is affected", 0, 0, false, 0, gbl.spell_id);
        }
        ...
        {
            DoSpellCastingWork("", DamageType.Magic | DamageType.Fire, ovr024.roll_dice_save(8, 6), false, 0,
                gbl.spell_id);
        }
        ...
        internal static void SpellEntangle() // cast_entangle
        {
            if (gbl.area_ptr.inDungeon == 0)
            {
                foreach (var target in gbl.spellTargets)
                {
                    ...
                    ovr024.ApplyAttackSpellAffect("is entangled", saved, DamageOnSave.Zero, false, 0,
                        GetSpellAffectTimeout((Spells) 0x88), Affects.entangle, target);
                }
            }
        }
        ...
        internal static void SpellConfusion() // cast_confuse
        {
            ...
            foreach (var target in gbl.spellTargets)
            {
                ...
                ovr024.ApplyAttackSpellAffect("is confused", saved, DamageOnSave.Zero, false, 0,
                    GetSpellAffectTimeout(Spells.confusion), Affects.cause_disease_2, target);
            }
        }
        ...
        internal static void SpellFear() /* cast_terror */
        {
            ...
            foreach (var target in gbl.spellTargets)
            {
                ...
                if (saves == false)
                {
                    ovr024.ApplyAttackSpellAffect("runs in terror", saves, DamageOnSave.Zero, true, 0,
                        GetSpellAffectTimeout(Spells.fear), Affects.fear, target);
        ...
        internal static void SpellFireProtection() // cast_protection
        {
            ...
            do
            {
                ...
                if (input_key == 'H')
                {
                    ovr024.ApplyAttackSpellAffect("is protected", false, 0, false, 0,
                        GetSpellAffectTimeout(Spells.fire_shield), Affects.hot_fire_shield, gbl.SelectedPlayer);
                    ovr024.ApplyAttackSpellAffect(string.Empty, false, 0, false, 0,
                        GetSpellAffectTimeout(Spells.fire_shield), Affects.protect_elec, gbl.SelectedPlayer);
                    var_3 = true;
                }
                else if (input_key == 'C')
                {
                    ovr024.ApplyAttackSpellAffect(string.Empty, false, 0, false, 0,
                        GetSpellAffectTimeout(Spells.fire_shield), Affects.cold_fire_shield, gbl.SelectedPlayer);
                    ovr024.ApplyAttackSpellAffect(string.Empty, false, 0, false, 0,
                        GetSpellAffectTimeout(Spells.fire_shield), Affects.protect_elec, gbl.SelectedPlayer);
                    var_3 = true;
                }
        ...
        internal static void SpellFumble() // spell_slow
        {
            ...
            if (ovr024.RollSavingThrow(0, SaveVerseType.Spell, target) == false)
            {
                ovr024.ApplyAttackSpellAffect("is clumsy", false, 0, false, 0, GetSpellAffectTimeout(Spells.fumble),
                    Affects.fumbling, target);
            ...
            {
                ovr024.ApplyAttackSpellAffect("is slowed", false, 0, false, 0, GetSpellAffectTimeout(Spells.fumble),
                    Affects.slow, target);
        ...
        internal static void SpellCloudKill() // spell_poisonous_cloud // similar to create_noxious_cloud
        {
            ...
            ovr024.add_affect(true, (byte) (var_15 + (count << 4)), var_15, Affects.affect_in_cloud_kill,
                gbl.SelectedPlayer);
                    ...
                    foreach (var var_4 in gbl.StinkingCloud)
                    {
                        for (int var_12 = 0; var_12 < 4; var_12++)
                        {
                            if (var_4.present[var_12] == true &&
                                (gbl.MapDirectionDelta[gbl.SmallCloudDirections[var_12]] + var_4.targetPos) ==
                                (gbl.MapDirectionDelta[dir] + gbl.targetPos) &&
                ...
                else if (ground_tile == gbl.Tile_CloudKill)
                {
                    ...
                    foreach (GasCloud var_4 in gbl.CloudKillCloud)
                    {
                        if (var_4 != var_8)
                        {
                            ...
                            {
                                if (var_4.present[var_12] == true &&
                                    (gbl.MapDirectionDelta[gbl.CloudDirections[var_12]] + var_4.targetPos) ==
                                    (gbl.MapDirectionDelta[dir] + gbl.targetPos) &&
                                    var_4.groundTile[var_12] != 0x1E &&
                                    var_4.groundTile[var_12] != 0x1C)
                                {
        ...
        internal static void SpellConeOfCold() // sub_61550
        {
            ...
            DoSpellCastingWork("", DamageType.Acid, target_count + ovr024.roll_dice_save(4, target_count), false, 0,
                gbl.spell_id);
        }
        ...
        internal static void sub_61727()
        {
            ...
            foreach (var target in gbl.spellTargets)
            {
                ...
                ovr024.damage_person(change_damage, gbl.spellCastingTable[(int) Spells.spell_62].damageOnSave,
                    ovr024.roll_dice_save(6, 6), target);
            }
        }
        ...
        internal static void AffectParalizingGaze(Effect arg_0, object param, Player player) /* spell_stone */
        {
            ...
            if (player.actions.target != null)
            {
                ...
                {
                    Item item = gbl.spell_target.items.Find(i =>
                        i.readied && (i.namenum1 == 0x76 || i.namenum2 == 0x76 || i.namenum3 == 0x76));

                    if (item != null)
                    {
                        ovr025.DisplayPlayerStatusString(false, 12, "reflects it!", gbl.spell_target);

                        ovr025.draw_missile_attack(0x2d, 4, ovr033.PlayerMapPos(player),
                            ovr033.PlayerMapPos(gbl.spell_target));
        ...
        internal static void AffectSpitAcid(Effect arg_0, object param, Player player) // spell_spit_acid
        {
                ...
                gbl.spell_target != null)
            {
                if (roll <= 30)
                {
                    ...
                    ovr025.draw_missile_attack(30, 1, ovr033.PlayerMapPos(gbl.spell_target),
                        ovr033.PlayerMapPos(player));

                    ovr024.damage_person(ovr024.RollSavingThrow(0, SaveVerseType.BreathWeapon, gbl.spell_target),
                        DamageOnSave.Half, player.hit_point_max, gbl.spell_target);
                }
                else
                {
        ...
        internal static void DragonBreathAcid(Effect arg_0, object param, Player attacker) // spell_breathes_acid
        {
            ...
            if (affect.affect_data > 0)
            {
                    ...
                    gbl.spellTargets.Count > 0)
                {
                    ...
                    ovr025.draw_missile_attack(0x1E, 1, ovr033.PlayerMapPos(gbl.spellTargets[0]),
                        ovr033.PlayerMapPos(attacker));
        ...
        internal static void cast_breath_fire(Effect arg_0, object param, Player arg_6)
        {
                ...
                ovr025.getTargetRange(gbl.spell_target, arg_6) < 2)
            {
                ...
                ovr024.damage_person(ovr024.RollSavingThrow(0, SaveVerseType.BreathWeapon, gbl.spell_target),
                    DamageOnSave.Half, 7, gbl.spell_target);
            }
        }
