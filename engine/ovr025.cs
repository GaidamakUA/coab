...
namespace engine
{
    class ovr025
    {
        ...
        internal static void
            draw_missile_attack(int delay, int frameCount, Point target, Point attacker) /* sub_67AA4 */
        {
            Point center;
            bool var_B4;
            bool var_B3;
        ...
        internal static void selectAPlayer(ref Player player, bool showExit, string prompt)
        {
            ...
            while (unk_68DFA.MemberOf(input_key) == false)
            {
                ...
                input_key = ovr027.displayInput(out special_key, useOverlay, 1, gbl.defaultMenuColors, "Select" + text,
                    prompt + " ");
