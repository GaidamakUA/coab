    ...
    class ovr013
    {
        ...
        internal static void BonusVsMonstersX(Effect arg_0, object param, Player player) // sub_3A17A
        {
                ...
                player.actions.target != null)
            {
                ...
                else if (gbl.spell_target.monsterType == MonsterType.type_9 ||
                         gbl.spell_target.monsterType == MonsterType.type_12)
                {
                    bonus = 2;
                }
        ...
        internal static void affect_spiritual_hammer(Effect add_remove, object param, Player player) /* sub_3A583 */
        {
            ...
            {
                item = new Item(Affects.affect_78, Affects.spiritual_hammer, 0, 0, 0, 0, false, 0, false, 0, 1, 243, 20,
                    0, ItemType.Hammer, true);
        ...
        internal static void AffectConfuse(Effect arg_0, object arg_2, Player player) // sub_3A9D9
        {
            ...
            {
                ovr024.ApplyAttackSpellAffect("goes berserk", false, DamageOnSave.Zero, true, (byte) player.combat_team,
                    1, Affects.affect_89, player);
        ...
        internal static void StinkingCloudAffect(Effect arg_0, object param, Player player) // sub_3AC1D
        {
            ...
            var var_8 = gbl.StinkingCloud.Find(cell =>
                cell.player == player && cell.field_1C == (affect.affect_data >> 4));
        ...
        internal static void
            AffectMinorGlobeOfInvulnerability(Effect arg_0, object param, Player player) /* sub_3B3CA */
        {
            if (gbl.spell_id > 0 &&
        ...
        internal static void sub_3C3F6(Effect arg_0, object param, Player player)
        {
            ...
            if (ovr024.roll_dice(100, 1) <= 25)
            {
                if (ovr025.getTargetRange(gbl.spell_target, player) < 4)
                {
                    ...
                    ovr025.draw_missile_attack(0x1e, 1, ovr033.PlayerMapPos(gbl.spell_target),
        ...
        internal static void
            CallAffectTable(Effect add_remove, object parameter, Player player, Affects affect) /* sub_630C7 */
        {
